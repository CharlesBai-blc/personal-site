...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const isNodeLogo = (item: LogoItem): item is Extract<LogoItem, { node: React.ReactNode }> =>
      'node' in item;

    const isImgLogo = (item: LogoItem): item is Extract<LogoItem, { src: string }> =>
      'src' in item;
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const href = isNodeLogo(item) ? item.href : isImgLogo(item) ? item.href : undefined;

    ...
    <aside className="fixed left-0 top-0 h-full w-72 bg-sidebar-bg border-r border-border shadow-sm z-50 hidden lg:block sidebar-hidden">
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 p-6">
          <ul className="space-y-1">
            <li>
              <Link 
                href="/" 
                className="flex items-center px-3 py-2 text-text-light hover:text-foreground hover:bg-secondary rounded-md transition-colors duration-200 group"
              >
        ...
        <div className="p-6 border-t border-border">
          <h3 className="text-xs font-semibold text-text-light uppercase tracking-wider mb-4">Connect</h3>
